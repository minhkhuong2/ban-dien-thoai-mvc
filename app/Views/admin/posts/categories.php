...
<div class="attribute-box">
    ...
    <form action="<?php echo URLROOT; ?>/admin/addPostCategory" method="POST" class="value-form">
        <input type="text" name="name" placeholder="Tên danh mục mới (ví dụ: Tin quốc tế)" required>
